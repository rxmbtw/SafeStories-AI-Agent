          ...
          <div className="mobile-modal therapists" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="therapist-list">
              <div className="therapist-card active" onClick={() => window.open('https://anjalipillai.dayschedule.com/individual-session-with-anjalipillai', '_blank')}>
                <img src={IMAGE_URLS.anjali_pillai} alt="Anjali Pillai" className="therapist-avatar" />
              ...
              <div className="therapist-card" onClick={() => window.open('https://ishika.dayschedule.com/session-with-ishika', '_blank')}>
                <img src={IMAGE_URLS.ishika_mahajan} alt="Ishika Mahajan" className="therapist-avatar" />
                <div className="therapist-details">
            ...
            <button className="go-back" onClick={() => { setShowIndividualModal(false); setShowScheduleModal(true); }}>
              Go Back
            </button>
          </div>
        </div>
      ...
      {showCouplesModal && (
        <div className="mobile-modal-overlay" onClick={() => setShowCouplesModal(false)}>
          <div className="mobile-modal therapists" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="therapist-list">
              <div className="therapist-card" onClick={() => window.open('https://ishika.dayschedule.com/couple-therapy-ishika', '_blank')}>
                <img src={IMAGE_URLS.ishika_mahajan} alt="Ishika Mahajan" className="therapist-avatar" />
                <div className="therapist-details">
                  <h3>Ishika Mahajan</h3>
            ...
            <button className="go-back" onClick={() => { setShowCouplesModal(false); setShowScheduleModal(true); }}>
              Go Back
            </button>
          </div>
        </div>
      ...
      {showAdolescentModal && (
        <div className="mobile-modal-overlay" onClick={() => setShowAdolescentModal(false)}>
          <div className="mobile-modal therapists" onClick={(e) => e.stopPropagation()}>
            ...
            <button className="go-back" onClick={() => { setShowAdolescentModal(false); setShowScheduleModal(true); }}>
              Go Back
            </button>
          </div>
        </div>
